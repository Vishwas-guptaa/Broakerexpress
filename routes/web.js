...
router.get('/admin/toppropertydelete/:id',auth,PropertyController.propertydelete)
router.get('/admin/toppropertyview/:id',auth,PropertyController.propertyview)
router.get('/admin/toppropertyview/:id/:hgf',auth,PropertyController.propertyview)
